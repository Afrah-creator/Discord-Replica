      ...
      <div className="relative z-10 container mx-auto px-6">
        ...
        >
          ...
          <h2 className="text-4xl md:text-6xl font-black text-foreground mb-4">
            UNLOCK MORE WITH{" "}
            <span className="text-gradient">N8 NITRO</span>
          </h2>
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Boost your N8 experience with bigger uploads, HD streaming, custom emoji, animated
            avatars, and special profile badges. Stand out and support your favourite servers.
          </p>
        </motion.div>
        ...
        >
          <a
            href="#"
            className="px-8 py-3 rounded-full gradient-blurple text-primary-foreground font-medium hover:opacity-90 transition-opacity"
          >
            Subscribe to Nitro
          </a>
          <a
